...
while True:
	for event in pygame.event.get():
		...
		if event.type == SPAWNPIPE:
			pipe_list.extend(AppGui.create_pipe())
		...
		if event.type == BIRDFLAP:
			...
			bird_surface,bird_rect = AppGui.bird_animation()
	...
	if game_active:
		...
		rotated_bird = AppGui.rotate_bird(bird_surface)
		bird_rect.centery += bird_movement
		screen.blit(rotated_bird,bird_rect)
		game_active = AppGui.check_collision(pipe_list)

		# Pipes
		pipe_list = AppGui.move_pipes(pipe_list)
		AppGui.draw_pipes(pipe_list)
		
		# Score
		AppGui.pipe_score_check()
		AppGui.score_display('main_game')
	else:
		screen.blit(game_over_surface,game_over_rect)
		high_score = AppGui.update_score(score,high_score)
		AppGui.score_display('game_over')
